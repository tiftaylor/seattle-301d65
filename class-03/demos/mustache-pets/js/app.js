...
// Steps to convert to mustache
// 1. write our template in html
// 2. call Mustache.render
// 3. put the result on the page
...
Pet.prototype.renderMustache = function () {
  const newHtml = Mustache.render($('#pet-template').html(), this);
  $('ul').append(newHtml);
};
...
const handleThePetsFromTheFile = dataPotato => {
  ...
  pets.forEach(petValue => petValue.renderMustache());
