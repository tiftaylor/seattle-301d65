...
function displayPics(){
  ...
  // Answer: Because the variable rando declared with 'let' is block-scoped to its specific code block (while), and thus could not be called upon outside of the while code-block
